...
object HavasuIcebergSqlParser extends SparkSqlParser {
  override val astBuilder = new HavasuIcebergAstBuilder

  class HavasuIcebergAstBuilder extends SparkSqlAstBuilder {
    /**
